...
- **Attenzione ai clone multipli:** opera sul clone che sta fisicamente sull'host MicroCloud (serve il socket LXD locale) — verifica il percorso esatto nel logbook compresso.
